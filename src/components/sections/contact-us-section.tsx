...
const ContactUsSection = ({ sectionRef, scrollToTop, sectionInView }) => (
  <section
    ref={sectionRef}
    className={`w-full h-screen min-h-[800px] snap-start relative flex items-center justify-center pointer-events-auto bg-black/50 mb-20 transition-all duration-1000 transform ${
